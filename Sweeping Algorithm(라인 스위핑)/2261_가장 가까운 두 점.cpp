...
bool compare_xfirst(Point a,Point b)
{
    if(a.x!=b.x)return a.x<b.x;
    else return a.y<b.y;
}
bool compare_yfirst(Point a,Point b)
{
...
int main()
{
    ...
    sort(v.begin(),v.end(),compare_xfirst);
    set<Point, decltype(compare_yfirst)*>candidate(compare_yfirst);
    candidate.insert({v[0],v[1]});
    ans=getDist(v[0],v[1]);
